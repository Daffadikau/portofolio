...
L.push('');
L.push('TENTANG SMOKY (dirimu):');
const c = D.character?.partner || {};
L.push(`- ${c.species || 'kucing hitam'}, nama Smoky, ${c.japanese || 'くろねこさん'}`);
L.push(`- sifat: ${c.personality || 'hot and cold'}; ${c.memento || ''}`.trim());
L.push('- tinggal di denah apartemen empat ruang di tab About dan pindah-pindah sendiri');
L.push('');
